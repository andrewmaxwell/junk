(module
 ...
 (func $assembly/index/clamp (param $value f64) (param $minValue f64) (param $maxValue f64) (result f64)
  local.get $value
  local.get $minValue
  f64.max
  local.get $maxValue
 ...
 (func $assembly/index/update (param $width i32) (param $height i32) (param $limit i32)
