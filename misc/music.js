...
2:39
Somebody That I Used To Know (Acappella)
Jared Halley
Somebody That I Used To Know (Acappella)
 
4:07
Africa (feat. Jeff Hall)
Mike Massé
Covers, Vol. 1 Excerpts: Most Viewed
...
4:23
Harvest Moon – Satin Jackets Remix
Poolside
Harvest Moon (Satin Jackets Remix)
...
Totem Transport
Arc De Soleil
No Cardigan in Michigan Please (Prologue)
...
4:44
Which Way To Paradise - Bosq Remix (feat. Bosq)
Poolside
...
3:21
Online (feat. Montaigne & Tom Cardy)
TWRP
Digital Nightmare
...
Big Data
Earth To Echo (Music From The Motion Picture)
...
5:13
Don't Want This to Be Over (Jean Tonique Remix) (feat. Satchmode)
Kraak & Smaak
Don't Want This to Be Over (Remixes)
...
const results = Object.entries(songs)
  ...
  .map(
    ([artist, titles]) =>
      `${artist} (${titles.length}): ${[...new Set(titles)].map((t) => `"${t}"`).join(', ')}`,
  )
  .join('\n');
